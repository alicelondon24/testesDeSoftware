...
public class TesteSistemaBancario{
	...
	private static void inicializaSistemaBancario() {
		...
		//criando e inserindo duas contas na lista de contas correntes
		ContaCorrente conta01 = new ContaCorrente(1, 0, true);
		ContaCorrente conta02 = new ContaCorrente(2, 0, true);
		contasDoBanco.add(conta01);
		contasDoBanco.add(conta02);
		
		//criando dois clientes e associando as contas acima a eles
		Cliente cliente01 = new Cliente(1, "Joao da silva", 20, "joao@gmail.com", conta01.getId(), true);
		Cliente cliente02 = new Cliente(2, "maria da silva", 20, "maria@gmail.com", conta02.getId(), true);
		
		//inserindo os clientes novos na lista de clientes do banco
